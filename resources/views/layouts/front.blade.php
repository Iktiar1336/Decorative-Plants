...
<head>
    ...
    <link href="{{asset('/front/assets/responsive/home/phone-responsive.css')}}" rel="stylesheet">
    <link href="{{asset('/front/assets/responsive/home/tablet-responsive.css')}}" rel="stylesheet">
    <link href="{{asset('/front/assets/responsive/home/desktop-responsive.css')}}" rel="stylesheet">
