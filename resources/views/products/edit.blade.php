                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="name">Nama Ilmiah Produk</label>
                                    <input type="text" name="ilmiah" class="form-control" value="{{ $product->ilmiah }}" required>
                                    <p class="text-danger">{{ $errors->first('ilmiah') }}</p>
                                </div>
                                <div class="form-group">
                                    <label for="name">Tingkatan Takson</label>
                                    <input type="text" name="takson" class="form-control" value="{{ $product->takson }}" required>
                                    <p class="text-danger">{{ $errors->first('takson') }}</p>
                                </div>
                                <div class="form-group">
                                    <label for="name">Ordo Produk</label>
                                    <input type="text" name="ordo" class="form-control" value="{{ $product->takson }}" required>
                                    <p class="text-danger">{{ $errors->first('ordo') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
